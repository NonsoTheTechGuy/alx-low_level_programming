...
- [Hash-bang under the hood ](https://intranet.alxswe.com/rltoken/BFBusLVUbFgGFcOGVPQcRw)(Look at only after you finish consuming the other resources)
...
- `cd` into the [Betty](https://intranet.alxswe.com/rltoken/QkZtBg3ps5iLBlUdX-CPJQ) directory
